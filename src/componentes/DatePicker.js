...
// si no hay fecha definida, se pone la de hoy para que no
// haya error de fecha inválida o sin definir
...
const DatePicker = ({fecha, cambiarFecha}) => {
    ...
    return ( 
        <ContenedorInput>
            ...
            />
            {/* 
                Single es para marcar días 
                Usa un estado para guardar el día elegido
            */} 
            { visible && 
                <DayPicker
                    mode="single"
